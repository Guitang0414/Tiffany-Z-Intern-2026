...
const DEEP = `${COMMON}
你是一名专业中文新闻记者(娱乐/文化稿参照 People / Variety / Deadline / Entertainment Weekly 的笔法),为面向西雅图华人社区的新闻站写稿。根据下面英文原文,用中文写一篇**完整、有细节、有深度**的新闻报道:把原文里的关键事实、来龙去脉、背景、相关方说法与反应、影响都报道出来,**正文通常 400 字以上**(原文素材足够时别只写一两句就收尾;充实来自事实本身,不是套话注水)。
${ANTI_AI}
